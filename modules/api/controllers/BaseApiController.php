...
{
    protected const string BEHAVIOR_CONTENT_NEGOTIATION = 'contentNegotiation';

    protected const string BEHAVIOR_VERB_FILTER = 'verbFilter';

    protected const string BEHAVIOR_CORS_FILTER = 'corsFilter';
